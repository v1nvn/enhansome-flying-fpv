...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,600 | 🐛 340 | 🌐 C | 📅 2026-02-11 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,707 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,657 | 🐛 69 | 🌐 C | 📅 2026-02-11 - ?.
...
* [madflight](https://github.com/qqqlab/madflight) ⭐ 373 | 🐛 3 | 🌐 C | 📅 2026-02-11 - For Arduino based target boards, different sensors supported, 2024
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,169 | 🐛 732 | 🌐 C | 📅 2026-02-11 - Successor of OpenTX under active development.

* [OpenTX](https://github.com/opentx/opentx) ⭐ 2,168 | 🐛 295 | 🌐 C++ | 📅 2025-12-19 - Firmware for popular handtransmitters including Desktop manager and sound packs.
...
* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 23 | 🐛 0 | 🌐 HTML | 📅 2026-02-11 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,725 | 🐛 53 | 🌐 C | 📅 2026-02-11 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,725 | 🐛 53 | 🌐 C | 📅 2026-02-11 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 515 | 🐛 20 | 🌐 C | 📅 2026-02-10 - Mavlink compatible LRS.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,302 | 🐛 28 | 🌐 C++ | 📅 2026-02-09 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,388 | 🐛 22 | 🌐 Python | 📅 2026-02-03 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 896 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,239 | 🐛 65 | 🌐 Rust | 📅 2026-01-14 - Use IMU sensor data to smooth HD video recordings.
...
* [AntTracker](https://github.com/zs6buj/AntTracker) ⭐ 187 | 🐛 1 | 🌐 C | 📅 2025-12-04 - Servo based using F1 / ESP8266 / ESP32 controllers, 2019.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,152 | 🐛 142 | 🌐 Python | 📅 2026-02-12 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 687 | 🐛 9 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,324 | 🐛 1,065 | 🌐 C++ | 📅 2026-02-12 - Mavlink, Desktop and mobile.
...
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 294 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2026-02-11 - Share Drone shots for disaster response etc.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 1,810 | 🐛 16 | 🌐 C | 📅 2025-06-16 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 17,947 | 🐛 725 | 🌐 C++ | 📅 2025-05-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,891 | 🐛 43 | 🌐 C++ | 📅 2026-02-10 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,206 | 🐛 517 | 🌐 C++ | 📅 2026-02-12 - Multi robot.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 955 | 🐛 0 | 🌐 C | 📅 2026-02-11 - UAV edition, supports also FLARM and more.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,207 | 🐛 20 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
