...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 754 | 🐛 99 | 🌐 C | 📅 2026-02-03 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,605 | 🐛 334 | 🌐 C | 📅 2026-02-14 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,708 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,654 | 🐛 70 | 🌐 C | 📅 2026-02-14 - ?.
...
* [madflight](https://github.com/qqqlab/madflight) ⭐ 377 | 🐛 2 | 🌐 C | 📅 2026-02-12 - For Arduino based target boards, different sensors supported, 2024
...
* [HPR-Rocket-Flight-Computer](https://github.com/SparkyVT/HPR-Rocket-Flight-Computer) ⭐ 136 | 🐛 0 | 🌐 C++ | 📅 2025-05-18 - High speed rockets firmware
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,172 | 🐛 735 | 🌐 C | 📅 2026-02-15 - Successor of OpenTX under active development.
...
* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 23 | 🐛 0 | 🌐 HTML | 📅 2026-02-14 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,730 | 🐛 55 | 🌐 C | 📅 2026-02-11 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,730 | 🐛 55 | 🌐 C | 📅 2026-02-11 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 515 | 🐛 20 | 🌐 C | 📅 2026-02-14 - Mavlink compatible LRS.
...
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,391 | 🐛 22 | 🌐 Python | 📅 2026-02-03 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 897 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,242 | 🐛 65 | 🌐 Rust | 📅 2026-02-14 - Use IMU sensor data to smooth HD video recordings.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 712 | 🐛 3 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
* [RC Headtracker](https://github.com/dlktdr/HeadTracker) ⭐ 447 | 🐛 55 | 🌐 C++ | 📅 2025-12-08 - Turn camera gimbal when you turn your googles. Based on Arduino and Bluetooth.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,157 | 🐛 142 | 🌐 Python | 📅 2026-02-12 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 687 | 🐛 10 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,330 | 🐛 1,064 | 🌐 C++ | 📅 2026-02-15 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,856 | 🐛 437 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 1,824 | 🐛 16 | 🌐 C | 📅 2025-06-16 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 17,947 | 🐛 727 | 🌐 C++ | 📅 2025-05-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,894 | 🐛 43 | 🌐 C++ | 📅 2026-02-10 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,207 | 🐛 516 | 🌐 C++ | 📅 2026-02-13 - Multi robot.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 955 | 🐛 0 | 🌐 C | 📅 2026-02-13 - UAV edition, supports also FLARM and more.
...
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 499 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
