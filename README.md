...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 595 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
* [JeNo 5.1"](https://github.com/WE-are-FPV/JeNo-5.1) ⭐ 60 | 🐛 0 | 📅 2025-12-23 - Modern carbon wide X-frame with accessoirs
...
* [ESC Configurator](https://github.com/stylesuxx/esc-configurator) ⭐ 221 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-02 - Web app to setup your BLHeli / Bluejay ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,813 | 🐛 324 | 🌐 C | 📅 2026-04-10 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,720 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,239 | 🐛 773 | 🌐 C | 📅 2026-04-10 - Successor of OpenTX under active development.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 540 | 🐛 19 | 🌐 C | 📅 2026-04-09 - Mavlink compatible LRS.
...
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 460 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 316 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 185 | 🐛 9 | 🌐 C++ | 📅 2026-02-16- Cheap ESPcam boards transimitting MJPEG frames.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,396 | 🐛 82 | 🌐 Rust | 📅 2026-04-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,731 | 🐛 554 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,492 | 🐛 1,044 | 🌐 C++ | 📅 2026-04-09 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 7 | 🌐 JavaScript | 📅 2026-04-08 - Uses GSM and MQTT for extra long range links.
...
* [öchìn CM4](https://github.com/ochin-space/ochin-CM4) ⭐ 99 | 🐛 0 | 🌐 Shell | 📅 2025-05-09 - RPI Compute Module carrier board dedicated for FC
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,255 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,207 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 708 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,028 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,095 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,992 | 🐛 45 | 🌐 C++ | 📅 2026-04-09 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,286 | 🐛 551 | 🌐 C++ | 📅 2026-04-10 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 969 | 🐛 0 | 🌐 C | 📅 2026-04-09 - Nano edition, supports also FLARM and more.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 202 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 372 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
