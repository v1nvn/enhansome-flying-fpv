...
* [MiniHawk-VTOL v2.0](https://github.com/StephenCarlson/MiniHawk-VTOL) ⭐ 287 | 🐛 16 | 📅 2022-06-19 - 3d printed with 3 props
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,100 | 🐛 35 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 804 | 🐛 106 | 🌐 C | 📅 2026-03-30 - DSHOT, telemetry, 2024
...
* [ESC Configurator](https://github.com/stylesuxx/esc-configurator) ⭐ 220 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-02 - Web app to setup your BLHeli / Bluejay ESC.
* [MESC FOC ESC](https://github.com/davidmolony/MESC_FOC_ESC) ⭐ 52 | 🐛 1 | 📅 2021-04-02 - Open Hardware and Firmware for STM32 basrd ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,798 | 🐛 318 | 🌐 C | 📅 2026-04-03 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,718 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,669 | 🐛 73 | 🌐 C | 📅 2026-04-03 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,363 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [madflight](https://github.com/qqqlab/madflight) ⭐ 408 | 🐛 4 | 🌐 C | 📅 2026-03-15 - For Arduino based target boards, different sensors supported, 2024
* [LibrePilot](https://github.com/librepilot/LibrePilot) ⭐ 353 | 🐛 18 | 🌐 C | 📅 2023-12-14 - Stall since 2018.
* [dRonin](https://github.com/d-ronin/dronin/) ⭐ 304 | 🐛 118 | 🌐 C++ | 📅 2021-09-13 - Supporting Openpilot and other target boards.
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 211 | 🐛 14 | 🌐 C | 📅 2026-04-03 - ?.
* [The Cube Autopilot](https://github.com/proficnc/The-Cube) ⭐ 155 | 🐛 0 | 🌐 HTML | 📅 2026-02-10 - FC hardware like the Pixhawk 2,
* [HPR-Rocket-Flight-Computer](https://github.com/SparkyVT/HPR-Rocket-Flight-Computer) ⭐ 142 | 🐛 0 | 🌐 C++ | 📅 2025-05-18 - High speed rockets firmware
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,844 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,232 | 🐛 760 | 🌐 C | 📅 2026-04-04 - Successor of OpenTX under active development.
...
* [Arduino Transmitter for ELRS](https://github.com/kkbin505/Arduino-Transmitter-for-ELRS) ⭐ 354 | 🐛 3 | 🌐 C++ | 📅 2025-04-05 - Simple gamepad like hand transmitter based on Arduino

* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 277 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 68 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 C | 📅 2026-04-04 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,839 | 🐛 52 | 🌐 C | 📅 2026-04-04 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,839 | 🐛 52 | 🌐 C | 📅 2026-04-04 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,844 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 538 | 🐛 18 | 🌐 C | 📅 2026-04-04 - Mavlink compatible LRS.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,327 | 🐛 28 | 🌐 C++ | 📅 2026-04-04 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,418 | 🐛 22 | 🌐 Python | 📅 2026-04-03 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 910 | 🐛 16 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
* [EZ Wifibroadcast](https://github.com/rodizio1/EZ-WifiBroadcast) ⭐ 894 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Oldest and first wifi based VTX setup.
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 458 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 315 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,383 | 🐛 83 | 🌐 Rust | 📅 2026-03-26 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,719 | 🐛 554 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [FENIX-rx5808-pro-diversity](https://github.com/JyeSmith/FENIX-rx5808-pro-diversity) ⭐ 106 | 🐛 5 | 🌐 C++ | 📅 2021-03-06 - Open Hardware 5,8GHz analog module with diversity for googles.
  * [rx5808 pro divesity](https://github.com/sheaivey/rx5808-pro-diversity) ⭐ 724 | 🐛 42 | 🌐 C++ | 📅 2024-02-21
...
* [u360gts](https://github.com/raul-ortega/u360gts/) ⭐ 260 | 🐛 39 | 🌐 C | 📅 2025-01-30 - 360° motor tracker using F2/F3 controllers that control, firmware + hardware + case, 2020.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,222 | 🐛 147 | 🌐 Python | 📅 2026-04-02 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 697 | 🐛 12 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [YAMSPy](https://github.com/thecognifly/YAMSPy) ⭐ 122 | 🐛 12 | 🌐 Python | 📅 2024-04-08 - Read MSP serial protocol with Python.
* [INAV blackbox viewer](https://github.com/iNavFlight/blackbox-log-viewer) ⭐ 47 | 🐛 20 | 🌐 JavaScript | 📅 2024-08-24 - Render sensor / motor values as video overlay OSD.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,480 | 🐛 1,048 | 🌐 C++ | 📅 2026-04-03 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-05 - Uses GSM and MQTT for extra long range links.
...
* [öchìn CM4](https://github.com/ochin-space/ochin-CM4) ⭐ 98 | 🐛 0 | 🌐 Shell | 📅 2025-05-09 - RPI Compute Module carrier board dedicated for FC
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,249 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,207 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 702 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 296 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-03-30 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 271 | 🐛 26 | 🌐 C++ | 📅 2026-04-03 - Store and archive drone shots and aerial imagery.
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 138 | 🐛 11 | 🌐 HTML | 📅 2026-03-31 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,024 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,086 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,980 | 🐛 46 | 🌐 C++ | 📅 2026-04-03 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,284 | 🐛 542 | 🌐 C++ | 📅 2026-04-04 - Multi robot.
* [jMAVSim](https://github.com/PX4/jMAVSim) ⭐ 103 | 🐛 16 | 🌐 Java | 📅 2026-01-29 - For Mavlink.
* [Picasim](https://github.com/Rowlhouse/PicaSim) ⭐ 20 | 🐛 2 | 🌐 C++ | 📅 2026-02-18 - For rc planes, closed source, sucessor of SSS.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 966 | 🐛 0 | 🌐 C | 📅 2026-04-04 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 275 | 🐛 44 | 🌐 C | 📅 2026-04-05 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 200 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,228 | 🐛 22 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 366 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 247 | 🐛 5 | 🌐 Python | 📅 2026-03-08 - Webfrontend to map DJI drones using their RemoteID.
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 224 | 🐛 228 | 🌐 Python | 📅 2024-06-24 - CVEs for semi-autonomous machines.
...
* [4AxisFoamCutter](https://github.com/rahulsarchive/4AxisFoamCutter) ⭐ 97 | 🐛 5 | 🌐 nesC | 📅 2021-07-22 - Create aerodynamic wings from foam.
