...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 795 | 🐛 105 | 🌐 C | 📅 2026-03-22 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,761 | 🐛 318 | 🌐 C | 📅 2026-03-28 - Focus on racing and agility for wings and copters.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,222 | 🐛 737 | 🌐 C | 📅 2026-03-28 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,822 | 🐛 61 | 🌐 C | 📅 2026-03-26 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,822 | 🐛 61 | 🌐 C | 📅 2026-03-26 - 2 way link for more complex telemetry downlink.
...
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 907 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,705 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,215 | 🐛 145 | 🌐 Python | 📅 2026-03-26 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,464 | 🐛 1,039 | 🌐 C++ | 📅 2026-03-29 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 57 | 🐛 9 | 🌐 JavaScript | 📅 2026-03-29 - Uses GSM and MQTT for extra long range links.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,236 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,200 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 694 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,076 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,966 | 🐛 48 | 🌐 C++ | 📅 2026-03-19 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,268 | 🐛 541 | 🌐 C++ | 📅 2026-03-27 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 965 | 🐛 0 | 🌐 C | 📅 2026-03-27 - Nano edition, supports also FLARM and more.
