...
* [JeNo 5.1"](https://github.com/WE-are-FPV/JeNo-5.1) ⭐ 61 | 🐛 0 | 📅 2025-12-23 - Modern carbon wide X-frame with accessoirs
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,101 | 🐛 35 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 811 | 🐛 103 | 🌐 C | 📅 2026-04-09 - DSHOT, telemetry, 2024
...
* [ESC Configurator](https://github.com/stylesuxx/esc-configurator) ⭐ 222 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-02 - Web app to setup your BLHeli / Bluejay ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,826 | 🐛 326 | 🌐 C | 📅 2026-04-10 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,721 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,670 | 🐛 73 | 🌐 C | 📅 2026-04-09 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,370 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,846 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,238 | 🐛 777 | 🌐 C | 📅 2026-04-11 - Successor of OpenTX under active development.
...
* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 278 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,851 | 🐛 53 | 🌐 C | 📅 2026-04-12 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,851 | 🐛 53 | 🌐 C | 📅 2026-04-12 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,846 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,331 | 🐛 28 | 🌐 C++ | 📅 2026-04-05 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
...
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 912 | 🐛 16 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
* [EZ Wifibroadcast](https://github.com/rodizio1/EZ-WifiBroadcast) ⭐ 896 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Oldest and first wifi based VTX setup.
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 461 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 316 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,398 | 🐛 81 | 🌐 Rust | 📅 2026-04-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,737 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 725 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,228 | 🐛 148 | 🌐 Python | 📅 2026-04-09 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 699 | 🐛 11 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
* [OpenLog](https://github.com/sparkfun/OpenLog) ⭐ 593 | 🐛 22 | 🌐 C++ | 📅 2022-06-09 - With [blackbox](https://github.com/thenickdude/blackbox/) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2015-01-14 firmware for blackbox data recorder (today usually part of main FC).
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 218 | 🐛 140 | 🌐 JavaScript | 📅 2026-02-25 - Web application for Ardupilot logs.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,497 | 🐛 1,048 | 🌐 C++ | 📅 2026-04-10 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 7 | 🌐 JavaScript | 📅 2026-04-12 - Uses GSM and MQTT for extra long range links.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,878 | 🐛 441 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,258 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,207 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 712 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 296 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2026-04-09 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 271 | 🐛 25 | 🌐 C++ | 📅 2026-04-09 - Store and archive drone shots and aerial imagery.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,030 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,103 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,994 | 🐛 45 | 🌐 C++ | 📅 2026-04-11 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,287 | 🐛 554 | 🌐 C++ | 📅 2026-04-10 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 969 | 🐛 0 | 🌐 C | 📅 2026-04-11 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 275 | 🐛 42 | 🌐 C | 📅 2026-04-07 - Share position and course via different radio transmitters.
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 374 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 250 | 🐛 5 | 🌐 Python | 📅 2026-03-08 - Webfrontend to map DJI drones using their RemoteID.
