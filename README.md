...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 596 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
* [JeNo 5.1"](https://github.com/WE-are-FPV/JeNo-5.1) ⭐ 62 | 🐛 0 | 📅 2025-12-23 - Modern carbon wide X-frame with accessoirs
...
* [MiniHawk-VTOL v2.0](https://github.com/StephenCarlson/MiniHawk-VTOL) ⭐ 288 | 🐛 16 | 📅 2022-06-19 - 3d printed with 3 props
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 812 | 🐛 104 | 🌐 C | 📅 2026-04-09 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,845 | 🐛 319 | 🌐 C | 📅 2026-04-13 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,721 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,671 | 🐛 72 | 🌐 C | 📅 2026-04-13 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,373 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
* [BaseFlight](https://github.com/multiwii/baseflight) ⭐ 523 | 🐛 23 | 🌐 C | 📅 2016-01-18 - Legacy and oldest FW of the days of Wii gyro hacks and 8bit, stall.
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 491 | 🐛 63 | 🌐 C | 📅 2026-03-30 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 411 | 🐛 4 | 🌐 C | 📅 2026-03-15 - For Arduino based target boards, different sensors supported, 2024
...
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 213 | 🐛 14 | 🌐 C | 📅 2026-04-03 - ?.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,847 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,239 | 🐛 778 | 🌐 C | 📅 2026-04-13 - Successor of OpenTX under active development.
...
* [Arduino Transmitter for ELRS](https://github.com/kkbin505/Arduino-Transmitter-for-ELRS) ⭐ 356 | 🐛 3 | 🌐 C++ | 📅 2025-04-05 - Simple gamepad like hand transmitter based on Arduino

* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 279 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 68 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 C | 📅 2026-04-11 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,857 | 🐛 53 | 🌐 C | 📅 2026-04-12 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,857 | 🐛 53 | 🌐 C | 📅 2026-04-12 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,847 | 🐛 115 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 542 | 🐛 12 | 🌐 C | 📅 2026-04-11 - Mavlink compatible LRS.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,332 | 🐛 24 | 🌐 C++ | 📅 2026-04-13 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,422 | 🐛 22 | 🌐 Python | 📅 2026-04-03 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
...
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 185 | 🐛 9 | 🌐 C++ | 📅 2026-04-11- Cheap ESPcam boards transimitting MJPEG frames.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,401 | 🐛 81 | 🌐 Rust | 📅 2026-04-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,739 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 727 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
* [RC Headtracker](https://github.com/dlktdr/HeadTracker) ⭐ 454 | 🐛 55 | 🌐 C++ | 📅 2025-12-08 - Turn camera gimbal when you turn your googles. Based on Arduino and Bluetooth.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,232 | 🐛 148 | 🌐 Python | 📅 2026-04-09 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 702 | 🐛 11 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
* [OpenLog](https://github.com/sparkfun/OpenLog) ⭐ 594 | 🐛 22 | 🌐 C++ | 📅 2022-06-09 - With [blackbox](https://github.com/thenickdude/blackbox/) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2015-01-14 firmware for blackbox data recorder (today usually part of main FC).
* [PID-Analyzer](https://github.com/Plasmatree/PID-Analyzer) ⭐ 415 | 🐛 33 | 🌐 Python | 📅 2021-03-04 - Read blackbox and tune PID control variables.
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 218 | 🐛 140 | 🌐 JavaScript | 📅 2026-04-13 - Web application for Ardupilot logs.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,500 | 🐛 1,051 | 🌐 C++ | 📅 2026-04-13 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,879 | 🐛 441 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,261 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,208 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 714 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 296 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-04-13 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 271 | 🐛 26 | 🌐 C++ | 📅 2026-04-14 - Store and archive drone shots and aerial imagery.
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 139 | 🐛 11 | 🌐 HTML | 📅 2026-03-31 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,032 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,110 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,996 | 🐛 47 | 🌐 C++ | 📅 2026-04-13 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,289 | 🐛 554 | 🌐 C++ | 📅 2026-04-10 - Multi robot.
* [jMAVSim](https://github.com/PX4/jMAVSim) ⭐ 103 | 🐛 16 | 🌐 Java | 📅 2026-01-29 - For Mavlink.
* [Picasim](https://github.com/Rowlhouse/PicaSim) ⭐ 20 | 🐛 4 | 🌐 C++ | 📅 2026-02-18 - For rc planes, closed source, sucessor of SSS.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 970 | 🐛 0 | 🌐 C | 📅 2026-04-13 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 277 | 🐛 41 | 🌐 C | 📅 2026-04-07 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 203 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,233 | 🐛 22 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 510 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 375 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 251 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - Webfrontend to map DJI drones using their RemoteID.
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 225 | 🐛 228 | 🌐 Python | 📅 2024-06-24 - CVEs for semi-autonomous machines.
...
* [Delta 5 race timer](https://github.com/scottgchin/delta5_race_timer) ⭐ 161 | 🐛 47 | 🌐 JavaScript | 📅 2021-06-08 - Use 5.8GHz video signals to trigger lap counter.
  * [RotorHazard](https://github.com/RotorHazard/RotorHazard) ⭐ 254 | 🐛 64 | 🌐 Python | 📅 2026-03-10 - Sucessor with multinode and central RPI server
