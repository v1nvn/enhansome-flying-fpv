...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 805 | 🐛 107 | 🌐 C | 📅 2026-04-05 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,802 | 🐛 324 | 🌐 C | 📅 2026-04-05 - Focus on racing and agility for wings and copters.
...
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,364 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,234 | 🐛 764 | 🌐 C | 📅 2026-04-05 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,841 | 🐛 52 | 🌐 C | 📅 2026-04-04 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,841 | 🐛 52 | 🌐 C | 📅 2026-04-04 - 2 way link for more complex telemetry downlink.
...
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 911 | 🐛 16 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,387 | 🐛 82 | 🌐 Rust | 📅 2026-04-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,721 | 🐛 554 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,223 | 🐛 147 | 🌐 Python | 📅 2026-04-02 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,481 | 🐛 1,048 | 🌐 C++ | 📅 2026-04-03 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 9 | 🌐 JavaScript | 📅 2026-04-06 - Uses GSM and MQTT for extra long range links.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,087 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,982 | 🐛 46 | 🌐 C++ | 📅 2026-04-03 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,284 | 🐛 543 | 🌐 C++ | 📅 2026-04-04 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 965 | 🐛 0 | 🌐 C | 📅 2026-04-06 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 275 | 🐛 41 | 🌐 C | 📅 2026-04-06 - Share position and course via different radio transmitters.
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 367 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 248 | 🐛 5 | 🌐 Python | 📅 2026-03-08 - Webfrontend to map DJI drones using their RemoteID.
