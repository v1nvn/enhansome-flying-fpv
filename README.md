...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 601 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
* [JeNo 5.1"](https://github.com/WE-are-FPV/JeNo-5.1) ⭐ 63 | 🐛 0 | 📅 2025-12-23 - Modern carbon wide X-frame with accessoirs
* [TBS Source X](https://github.com/ps915/source_x) ⭐ 40 | 🐛 1 | 📅 2019-06-10 - Carbon racing frame, 2019.
...
* [MiniHawk-VTOL v2.0](https://github.com/StephenCarlson/MiniHawk-VTOL) ⭐ 290 | 🐛 16 | 📅 2022-06-19 - 3d printed with 3 props
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,103 | 🐛 36 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 826 | 🐛 109 | 🌐 C | 📅 2026-04-24 - DSHOT, telemetry, 2024
...
* [ESC Configurator](https://github.com/stylesuxx/esc-configurator) ⭐ 223 | 🐛 39 | 🌐 JavaScript | 📅 2026-04-02 - Web app to setup your BLHeli / Bluejay ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,887 | 🐛 325 | 🌐 C | 📅 2026-04-24 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,721 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,673 | 🐛 71 | 🌐 C | 📅 2026-04-24 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,381 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 491 | 🐛 73 | 🌐 C | 📅 2026-04-24 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 418 | 🐛 5 | 🌐 C | 📅 2026-03-15 - For Arduino based target boards, different sensors supported, 2024
...
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 215 | 🐛 14 | 🌐 C | 📅 2026-04-24 - ?.
* [The Cube Autopilot](https://github.com/proficnc/The-Cube) ⭐ 155 | 🐛 1 | 🌐 HTML | 📅 2026-02-10 - FC hardware like the Pixhawk 2,
* [HPR-Rocket-Flight-Computer](https://github.com/SparkyVT/HPR-Rocket-Flight-Computer) ⭐ 142 | 🐛 0 | 🌐 C++ | 📅 2026-04-07 - High speed rockets firmware
* [Rotorflight](https://github.com/rotorflight/rotorflight) ⭐ 77 | 🐛 14 | 📅 2026-02-23 - Firmware for traditional single-rotor helicopters.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,850 | 🐛 117 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,249 | 🐛 759 | 🌐 C | 📅 2026-04-25 - Successor of OpenTX under active development.
...
* [Arduino Transmitter for ELRS](https://github.com/kkbin505/Arduino-Transmitter-for-ELRS) ⭐ 357 | 🐛 3 | 🌐 C++ | 📅 2025-04-05 - Simple gamepad like hand transmitter based on Arduino

* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 280 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 68 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 HTML | 📅 2026-04-19 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,889 | 🐛 49 | 🌐 C | 📅 2026-04-23 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,889 | 🐛 49 | 🌐 C | 📅 2026-04-23 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,850 | 🐛 117 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 549 | 🐛 11 | 🌐 C | 📅 2026-04-24 - Mavlink compatible LRS.
* [openLRSng](https://github.com/openLRSng/openLRSng) ⭐ 288 | 🐛 45 | 🌐 C | 📅 2018-11-22 - Next generation of OpenLRS, stall since 2018.
* [Raven LRS](https://github.com/RavenLRS/raven) ⭐ 172 | 🐛 9 | 🌐 C | 📅 2020-06-04 - Lora based, 2019.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,340 | 🐛 24 | 🌐 C++ | 📅 2026-04-21 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,429 | 🐛 22 | 🌐 Python | 📅 2026-04-03 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 913 | 🐛 16 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
* [EZ Wifibroadcast](https://github.com/rodizio1/EZ-WifiBroadcast) ⭐ 894 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Oldest and first wifi based VTX setup.
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 467 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 318 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 188 | 🐛 10 | 🌐 C++ | 📅 2026-04-19- Cheap ESPcam boards transimitting MJPEG frames.
* [DigiView-SBC](https://github.com/fpvout/DigiView-SBC) ⭐ 110 | 🐛 10 | 🌐 CSS | 📅 2021-06-23 - Receive DJI HD signal, alpha 2021.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,435 | 🐛 78 | 🌐 Rust | 📅 2026-04-22 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,755 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 731 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
* [RC Headtracker](https://github.com/dlktdr/HeadTracker) ⭐ 454 | 🐛 54 | 🌐 C++ | 📅 2026-04-14 - Turn camera gimbal when you turn your googles. Based on Arduino and Bluetooth.
* [TetraPI](https://github.com/bluegreen-labs/TetraPi) ⭐ 38 | 🐛 0 | 📅 2021-05-26 - Multispectra RPI based camera module.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,247 | 🐛 150 | 🌐 Python | 📅 2026-04-22 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 703 | 🐛 9 | 🌐 Lua | 📅 2026-04-16 - Script to show telemetry and control e.g. CAM, VTX settings.
* [OpenLog](https://github.com/sparkfun/OpenLog) ⭐ 592 | 🐛 22 | 🌐 C++ | 📅 2022-06-09 - With [blackbox](https://github.com/thenickdude/blackbox/) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2015-01-14 firmware for blackbox data recorder (today usually part of main FC).
* [PID-Analyzer](https://github.com/Plasmatree/PID-Analyzer) ⭐ 418 | 🐛 33 | 🌐 Python | 📅 2021-03-04 - Read blackbox and tune PID control variables.
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 227 | 🐛 138 | 🌐 JavaScript | 📅 2026-04-21 - Web application for Ardupilot logs.
* [openXsensor](https://github.com/openXsensor/openXsensor) ⭐ 186 | 🐛 37 | 🌐 C | 📅 2023-07-30 - Convert and alter telemetry protocols.
* [YAMSPy](https://github.com/thecognifly/YAMSPy) ⭐ 123 | 🐛 12 | 🌐 Python | 📅 2024-04-08 - Read MSP serial protocol with Python.
* [INAV blackbox viewer](https://github.com/iNavFlight/blackbox-log-viewer) ⭐ 48 | 🐛 20 | 🌐 JavaScript | 📅 2024-08-24 - Render sensor / motor values as video overlay OSD.
* [otxtelemetry](https://github.com/olliw42/otxtelemetry) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2023-12-26 - OpenTX / EdgeTX script to add Mavlink support.
* [INAV blackbox tools](https://github.com/iNavFlight/blackbox-tools) ⭐ 26 | 🐛 2 | 🌐 C | 📅 2026-01-17 - Convert to CSV timeseries files or as visual OSD overlay.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,532 | 🐛 1,054 | 🌐 C++ | 📅 2026-04-23 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,881 | 🐛 441 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,271 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,214 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 726 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 294 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2026-04-22 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 270 | 🐛 24 | 🌐 C++ | 📅 2026-04-24 - Store and archive drone shots and aerial imagery.
* [Fire Detection UAV](https://github.com/AlirezaShamsoshoara/Fire-Detection-UAV-Aerial-Image-Classification-Segmentation-UnmannedAerialVehicle) ⭐ 247 | 🐛 8 | 🌐 Python | 📅 2021-05-06 - ML learn drones to spot fire.
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 140 | 🐛 12 | 🌐 HTML | 📅 2026-04-21 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,042 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,125 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,019 | 🐛 48 | 🌐 C++ | 📅 2026-04-22 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,303 | 🐛 552 | 🌐 C++ | 📅 2026-04-24 - Multi robot.
* [jMAVSim](https://github.com/PX4/jMAVSim) ⭐ 103 | 🐛 16 | 🌐 Java | 📅 2026-01-29 - For Mavlink.
* [Picasim](https://github.com/Rowlhouse/PicaSim) ⭐ 22 | 🐛 4 | 🌐 C++ | 📅 2026-02-18 - For rc planes, closed source, sucessor of SSS.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 971 | 🐛 0 | 🌐 C | 📅 2026-04-24 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 281 | 🐛 42 | 🌐 C | 📅 2026-04-18 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 209 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,238 | 🐛 22 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 517 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 384 | 🐛 19 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 256 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - Webfrontend to map DJI drones using their RemoteID.
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 227 | 🐛 228 | 🌐 Python | 📅 2024-06-24 - CVEs for semi-autonomous machines.
...
* [Delta 5 race timer](https://github.com/scottgchin/delta5_race_timer) ⭐ 161 | 🐛 47 | 🌐 JavaScript | 📅 2021-06-08 - Use 5.8GHz video signals to trigger lap counter.
  * [RotorHazard](https://github.com/RotorHazard/RotorHazard) ⭐ 256 | 🐛 64 | 🌐 Python | 📅 2026-04-18 - Sucessor with multinode and central RPI server
