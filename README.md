...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 598 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
...
* [BLheli\_S](https://github.com/bitdump/BLHeli) ⭐ 2,195 | 🐛 411 | 🌐 Assembly | 📅 2025-08-21 - Popular Firmware for ESCs with fine-grained control.
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 819 | 🐛 106 | 🌐 C | 📅 2026-04-17 - DSHOT, telemetry, 2024
* [BlueJay](https://github.com/mathiasvr/bluejay) ⭐ 551 | 🐛 23 | 🌐 Assembly | 📅 2022-08-31 - BLheli fork, Digital ESC firmware for controlling brushless motors. More features like custom melodies. Since 2020.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,867 | 🐛 319 | 🌐 C | 📅 2026-04-18 - Focus on racing and agility for wings and copters.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 491 | 🐛 63 | 🌐 C | 📅 2026-03-30 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 414 | 🐛 4 | 🌐 C | 📅 2026-03-15 - For Arduino based target boards, different sensors supported, 2024
...
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 214 | 🐛 14 | 🌐 C | 📅 2026-04-03 - ?.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,241 | 🐛 778 | 🌐 C | 📅 2026-04-18 - Successor of OpenTX under active development.
...
* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 280 | 🐛 19 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 68 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 HTML | 📅 2026-04-18 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,871 | 🐛 53 | 🌐 C | 📅 2026-04-18 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,871 | 🐛 53 | 🌐 C | 📅 2026-04-18 - 2 way link for more complex telemetry downlink.
...
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 463 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 317 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 187 | 🐛 9 | 🌐 C++ | 📅 2026-04-11- Cheap ESPcam boards transimitting MJPEG frames.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,420 | 🐛 82 | 🌐 Rust | 📅 2026-04-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,745 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,241 | 🐛 148 | 🌐 Python | 📅 2026-04-15 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 222 | 🐛 140 | 🌐 JavaScript | 📅 2026-04-13 - Web application for Ardupilot logs.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,514 | 🐛 1,051 | 🌐 C++ | 📅 2026-04-17 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,880 | 🐛 441 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,210 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
...
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,004 | 🐛 47 | 🌐 C++ | 📅 2026-04-15 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,291 | 🐛 550 | 🌐 C++ | 📅 2026-04-16 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 969 | 🐛 0 | 🌐 C | 📅 2026-04-16 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 280 | 🐛 41 | 🌐 C | 📅 2026-04-18 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 205 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,234 | 🐛 22 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 378 | 🐛 18 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 252 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - Webfrontend to map DJI drones using their RemoteID.
