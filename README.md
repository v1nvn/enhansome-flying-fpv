...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 783 | 🐛 101 | 🌐 C | 📅 2026-03-18 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,721 | 🐛 318 | 🌐 C | 📅 2026-03-18 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,717 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,664 | 🐛 69 | 🌐 C | 📅 2026-03-18 - ?.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,207 | 🐛 737 | 🌐 C | 📅 2026-03-19 - Successor of OpenTX under active development.
...
* [Arduino Transmitter for ELRS](https://github.com/kkbin505/Arduino-Transmitter-for-ELRS) ⭐ 351 | 🐛 3 | 🌐 C++ | 📅 2025-04-05 - Simple gamepad like hand transmitter based on Arduino
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,794 | 🐛 58 | 🌐 C | 📅 2026-03-08 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,794 | 🐛 58 | 🌐 C | 📅 2026-03-08 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 527 | 🐛 26 | 🌐 C | 📅 2026-03-19 - Mavlink compatible LRS.
...
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 903 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,327 | 🐛 80 | 🌐 Rust | 📅 2026-03-06 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,687 | 🐛 549 | 🌐 C++ | 📅 2026-03-18 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,204 | 🐛 145 | 🌐 Python | 📅 2026-03-19 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 694 | 🐛 10 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,431 | 🐛 1,038 | 🌐 C++ | 📅 2026-03-19 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,874 | 🐛 440 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,221 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 262 | 🐛 24 | 🌐 C++ | 📅 2026-03-19 - Store and archive drone shots and aerial imagery.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 1,996 | 🐛 16 | 🌐 C | 📅 2026-03-03 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,027 | 🐛 728 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,942 | 🐛 47 | 🌐 C++ | 📅 2026-03-14 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,251 | 🐛 535 | 🌐 C++ | 📅 2026-03-19 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 962 | 🐛 0 | 🌐 C | 📅 2026-03-17 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 269 | 🐛 44 | 🌐 C | 📅 2026-03-02 - Share position and course via different radio transmitters.
...
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 508 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
