...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 615 | 🐛 25 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
* [JeNo 5.1"](https://github.com/WE-are-FPV/JeNo-5.1) ⭐ 68 | 🐛 0 | 📅 2025-12-23 - Modern carbon wide X-frame with accessoirs
* [TBS Source X](https://github.com/ps915/source_x) ⭐ 43 | 🐛 1 | 📅 2019-06-10 - Carbon racing frame, 2019.
* [TBS Source Podracer](https://github.com/ps915/source_podracer) ⭐ 38 | 🐛 1 | 📅 2020-07-18 - 3D carbon racing frame, 2020.
...
* [MiniHawk-VTOL v2.0](https://github.com/StephenCarlson/MiniHawk-VTOL) ⭐ 297 | 🐛 16 | 📅 2022-06-19 - 3d printed with 3 props
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,113 | 🐛 36 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [BLheli\_S](https://github.com/bitdump/BLHeli) ⭐ 2,203 | 🐛 411 | 🌐 Assembly | 📅 2025-08-21 - Popular Firmware for ESCs with fine-grained control.
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 860 | 🐛 119 | 🌐 C | 📅 2026-05-23 - DSHOT, telemetry, 2024
* [BlueJay](https://github.com/mathiasvr/bluejay) ⭐ 552 | 🐛 23 | 🌐 Assembly | 📅 2022-08-31 - BLheli fork, Digital ESC firmware for controlling brushless motors. More features like custom melodies. Since 2020.
* [ESC Configurator](https://github.com/stylesuxx/esc-configurator) ⭐ 225 | 🐛 40 | 🌐 JavaScript | 📅 2026-04-02 - Web app to setup your BLHeli / Bluejay ESC.
* [MESC FOC ESC](https://github.com/davidmolony/MESC_FOC_ESC) ⭐ 54 | 🐛 1 | 📅 2021-04-02 - Open Hardware and Firmware for STM32 basrd ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 11,011 | 🐛 347 | 🌐 C | 📅 2026-05-28 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,722 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,681 | 🐛 69 | 🌐 C | 📅 2026-05-28 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,394 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 495 | 🐛 54 | 🌐 C | 📅 2026-05-28 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 436 | 🐛 6 | 🌐 C | 📅 2026-05-18 - For Arduino based target boards, different sensors supported, 2024
* [LibrePilot](https://github.com/librepilot/LibrePilot) ⭐ 355 | 🐛 18 | 🌐 C | 📅 2023-12-14 - Stall since 2018.
* [dRonin](https://github.com/d-ronin/dronin/) ⭐ 305 | 🐛 118 | 🌐 C++ | 📅 2021-09-13 - Supporting Openpilot and other target boards.
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 216 | 🐛 14 | 🌐 C | 📅 2026-05-26 - ?.
* [The Cube Autopilot](https://github.com/proficnc/The-Cube) ⭐ 158 | 🐛 4 | 🌐 HTML | 📅 2026-05-06 - FC hardware like the Pixhawk 2,
* [HPR-Rocket-Flight-Computer](https://github.com/SparkyVT/HPR-Rocket-Flight-Computer) ⭐ 148 | 🐛 0 | 🌐 C++ | 📅 2026-04-07 - High speed rockets firmware
* [Rotorflight](https://github.com/rotorflight/rotorflight) ⭐ 77 | 🐛 15 | 📅 2026-02-23 - Firmware for traditional single-rotor helicopters.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,865 | 🐛 121 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,297 | 🐛 784 | 🌐 C | 📅 2026-05-29 - Successor of OpenTX under active development.

* [OpenTX](https://github.com/opentx/opentx) ⭐ 2,177 | 🐛 295 | 🌐 C++ | 📅 2025-12-19 - Firmware for popular handtransmitters including Desktop manager and sound packs.

* [Arduino Transmitter for ELRS](https://github.com/kkbin505/Arduino-Transmitter-for-ELRS) ⭐ 359 | 🐛 3 | 🌐 C++ | 📅 2025-04-05 - Simple gamepad like hand transmitter based on Arduino

* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 291 | 🐛 19 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 69 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 HTML | 📅 2026-05-07 - Custom TX based on Arduino Mega2560 boards.
...
* [OpenTX-Pong](https://github.com/SpechtD/OpenTX-Pong) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2021-09-30 - Simple game for your TX.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,971 | 🐛 52 | 🌐 C | 📅 2026-05-28 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,971 | 🐛 52 | 🌐 C | 📅 2026-05-28 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,865 | 🐛 121 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 568 | 🐛 15 | 🌐 C | 📅 2026-05-09 - Mavlink compatible LRS.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,363 | 🐛 26 | 🌐 C++ | 📅 2026-05-28 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,446 | 🐛 22 | 🌐 Python | 📅 2026-05-14 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 919 | 🐛 16 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
* [EZ Wifibroadcast](https://github.com/rodizio1/EZ-WifiBroadcast) ⭐ 895 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Oldest and first wifi based VTX setup.
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 477 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 322 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 198 | 🐛 8 | 🌐 C++ | 📅 2026-05-24- Cheap ESPcam boards transimitting MJPEG frames.
* [DigiView-SBC](https://github.com/fpvout/DigiView-SBC) ⭐ 109 | 🐛 10 | 🌐 CSS | 📅 2021-06-23 - Receive DJI HD signal, alpha 2021.
* [wfb-ng on OpenIPC](https://github.com/OpenIPC/sandbox-fpv) ⭐ 67 | 🐛 0 | 🌐 C | 📅 2024-01-10 - Wifibroadcast NG on OpenIPC compatible CCTV modules, capable of 120fps or 4k video feeds with telemetry. Existing commercial kits from various vendors (aka. EMAX Wyvern Link, Runcam Wifilink).
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,864 | 🐛 97 | 🌐 Rust | 📅 2026-05-16 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,830 | 🐛 558 | 🌐 C++ | 📅 2026-05-27 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 742 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
* [RC Headtracker](https://github.com/dlktdr/HeadTracker) ⭐ 456 | 🐛 55 | 🌐 C++ | 📅 2026-04-14 - Turn camera gimbal when you turn your googles. Based on Arduino and Bluetooth.
* [TetraPI](https://github.com/bluegreen-labs/TetraPi) ⭐ 39 | 🐛 0 | 📅 2021-05-26 - Multispectra RPI based camera module.
...
* [QLiteOSD](https://github.com/Qrome/QLiteOSD) ⭐ 31 | 🐛 6 | 🌐 C++ | 📅 2024-07-20 - ESP32 based OSD to read sensors without FC.
...
* [FENIX-rx5808-pro-diversity](https://github.com/JyeSmith/FENIX-rx5808-pro-diversity) ⭐ 106 | 🐛 5 | 🌐 C++ | 📅 2021-03-06 - Open Hardware 5,8GHz analog module with diversity for googles.
  * [rx5808 pro divesity](https://github.com/sheaivey/rx5808-pro-diversity) ⭐ 730 | 🐛 42 | 🌐 C++ | 📅 2024-02-21
* [rpi-rx5808-stream](https://github.com/xythobuz/rpi-rx5808-stream) ⭐ 40 | 🐛 0 | 🌐 Python | 📅 2017-06-20 - RPI based 5,8GHz analog with diversity streaming server.
...
* [u360gts](https://github.com/raul-ortega/u360gts/) ⭐ 263 | 🐛 39 | 🌐 C | 📅 2025-01-30 - 360° motor tracker using F2/F3 controllers that control, firmware + hardware + case, 2020.
* [AntTracker](https://github.com/zs6buj/AntTracker) ⭐ 189 | 🐛 1 | 🌐 C | 📅 2025-12-04 - Servo based using F1 / ESP8266 / ESP32 controllers, 2019.
* [open360tracker](https://github.com/SamuelBrucksch/open360tracker) ⭐ 42 | 🐛 3 | 🌐 C++ | 📅 2016-11-02 - 360° servo tracker 2016.
  * [Amv-open360tracker](https://github.com/raul-ortega/amv-open360tracker) ⭐ 26 | 🐛 0 | 🌐 C++ | 📅 2016-03-10 - Fork 2016.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,298 | 🐛 160 | 🌐 Python | 📅 2026-05-28 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 709 | 🐛 8 | 🌐 Lua | 📅 2026-04-16 - Script to show telemetry and control e.g. CAM, VTX settings.
* [OpenLog](https://github.com/sparkfun/OpenLog) ⭐ 595 | 🐛 22 | 🌐 C++ | 📅 2026-04-28 - With [blackbox](https://github.com/thenickdude/blackbox/) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2015-01-14 firmware for blackbox data recorder (today usually part of main FC).
* [PID-Analyzer](https://github.com/Plasmatree/PID-Analyzer) ⭐ 420 | 🐛 33 | 🌐 Python | 📅 2021-03-04 - Read blackbox and tune PID control variables.
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 240 | 🐛 138 | 🌐 JavaScript | 📅 2026-05-07 - Web application for Ardupilot logs.
* [openXsensor](https://github.com/openXsensor/openXsensor) ⭐ 186 | 🐛 37 | 🌐 C | 📅 2023-07-30 - Convert and alter telemetry protocols.
* [YAMSPy](https://github.com/thecognifly/YAMSPy) ⭐ 126 | 🐛 12 | 🌐 Python | 📅 2024-04-08 - Read MSP serial protocol with Python.
* [INAV blackbox viewer](https://github.com/iNavFlight/blackbox-log-viewer) ⭐ 50 | 🐛 20 | 🌐 JavaScript | 📅 2024-08-24 - Render sensor / motor values as video overlay OSD.
* [otxtelemetry](https://github.com/olliw42/otxtelemetry) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2023-12-26 - OpenTX / EdgeTX script to add Mavlink support.
* [INAV blackbox tools](https://github.com/iNavFlight/blackbox-tools) ⭐ 27 | 🐛 2 | 🌐 C | 📅 2026-01-17 - Convert to CSV timeseries files or as visual OSD overlay.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,624 | 🐛 1,034 | 🌐 C++ | 📅 2026-05-28 - Mavlink, Desktop and mobile.
...
* [Dreka GCS](https://github.com/Midgrad/Dreka) ⭐ 63 | 🐛 12 | 🌐 QML | 📅 2022-10-27 - A new GCS (currently limited but more modern look & feel).
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-21 - Uses GSM and MQTT for extra long range links.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,900 | 🐛 443 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
* [öchìn CM4](https://github.com/ochin-space/ochin-CM4) ⭐ 100 | 🐛 0 | 🌐 Shell | 📅 2025-05-09 - RPI Compute Module carrier board dedicated for FC
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,304 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,222 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 755 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 296 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-05-26 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 273 | 🐛 25 | 🌐 C++ | 📅 2026-05-28 - Store and archive drone shots and aerial imagery.
* [Fire Detection UAV](https://github.com/AlirezaShamsoshoara/Fire-Detection-UAV-Aerial-Image-Classification-Segmentation-UnmannedAerialVehicle) ⭐ 250 | 🐛 8 | 🌐 Python | 📅 2021-05-06 - ML learn drones to spot fire.
* [Drone-net](https://github.com/chuanenlin/drone-net) ⭐ 166 | 🐛 8 | 🌐 Python | 📅 2020-10-01 - ML detect quadcopters within photos / videos using YOLO v4.
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 141 | 🐛 12 | 🌐 HTML | 📅 2026-05-23 - ML find persons in disaster response by emergency markers.
* [OpenAthena](https://github.com/mkrupczak3/OpenAthena) ⚠️ Archived - Auto GCP detection using markers
* [AirPose](https://github.com/robot-perception-group/AirPose) ⭐ 55 | 🐛 4 | 🌐 Python | 📅 2022-02-21 - ML human pose estimation from drone perspective.
...
* [AruCo landing](https://github.com/radekholy24/aruco-landing) ⚠️ Archived - ML ROS addon to land on marker positions
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,122 | 🐛 3 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,196 | 🐛 725 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,082 | 🐛 46 | 🌐 C++ | 📅 2026-05-25 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,353 | 🐛 585 | 🌐 C++ | 📅 2026-05-29 - Multi robot.
* [jMAVSim](https://github.com/PX4/jMAVSim) ⭐ 103 | 🐛 16 | 🌐 Java | 📅 2026-01-29 - For Mavlink.
* [Picasim](https://github.com/Rowlhouse/PicaSim) ⭐ 24 | 🐛 2 | 🌐 C++ | 📅 2026-05-16 - For rc planes, closed source, sucessor of SSS.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 980 | 🐛 0 | 🌐 C | 📅 2026-05-29 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 290 | 🐛 50 | 🌐 C | 📅 2026-04-18 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 225 | 🐛 39 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
* [INAV Radar](https://github.com/OlivierC-FR/ESP32-INAV-Radar) ⭐ 93 | 🐛 4 | 🌐 C++ | 📅 2022-05-02 - LORA radio and ESP32 broadcast positions and show it at your OSD.
* [WiFi RID capture](https://github.com/sxjack/unix_rid_capture) ⭐ 66 | 🐛 9 | 🌐 C | 📅 2023-04-20 - Capture remote identification signals  with sniffer.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,274 | 🐛 23 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 531 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 401 | 🐛 19 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 275 | 🐛 5 | 🌐 Python | 📅 2026-05-18 - Webfrontend to map DJI drones using their RemoteID.
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 231 | 🐛 227 | 🌐 Python | 📅 2026-05-28 - CVEs for semi-autonomous machines.
...
* [Delta 5 race timer](https://github.com/scottgchin/delta5_race_timer) ⭐ 161 | 🐛 46 | 🌐 JavaScript | 📅 2021-06-08 - Use 5.8GHz video signals to trigger lap counter.
  * [RotorHazard](https://github.com/RotorHazard/RotorHazard) ⭐ 256 | 🐛 69 | 🌐 Python | 📅 2026-05-29 - Sucessor with multinode and central RPI server
...
* [4AxisFoamCutter](https://github.com/rahulsarchive/4AxisFoamCutter) ⭐ 99 | 🐛 5 | 🌐 nesC | 📅 2021-07-22 - Create aerodynamic wings from foam.
