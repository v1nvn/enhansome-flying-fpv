...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 612 | 🐛 25 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,111 | 🐛 36 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [BLheli\_S](https://github.com/bitdump/BLHeli) ⭐ 2,199 | 🐛 411 | 🌐 Assembly | 📅 2025-08-21 - Popular Firmware for ESCs with fine-grained control.
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 858 | 🐛 118 | 🌐 C | 📅 2026-05-20 - DSHOT, telemetry, 2024
...
* [MESC FOC ESC](https://github.com/davidmolony/MESC_FOC_ESC) ⭐ 53 | 🐛 1 | 📅 2021-04-02 - Open Hardware and Firmware for STM32 basrd ESC.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,985 | 🐛 342 | 🌐 C | 📅 2026-05-22 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,722 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,678 | 🐛 69 | 🌐 C | 📅 2026-05-21 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,391 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 494 | 🐛 50 | 🌐 C | 📅 2026-05-22 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 433 | 🐛 4 | 🌐 C | 📅 2026-05-18 - For Arduino based target boards, different sensors supported, 2024
...
* [QUICKSILVER firmware](https://github.com/BossHobby/QUICKSILVER) ⭐ 216 | 🐛 14 | 🌐 C | 📅 2026-05-19 - ?.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,861 | 🐛 118 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,287 | 🐛 762 | 🌐 C | 📅 2026-05-21 - Successor of OpenTX under active development.
...
* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 289 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,952 | 🐛 54 | 🌐 C | 📅 2026-05-22 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,952 | 🐛 54 | 🌐 C | 📅 2026-05-22 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,861 | 🐛 118 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
...
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 476 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 322 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 195 | 🐛 8 | 🌐 C++ | 📅 2026-05-21- Cheap ESPcam boards transimitting MJPEG frames.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,791 | 🐛 94 | 🌐 Rust | 📅 2026-05-16 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,809 | 🐛 559 | 🌐 C++ | 📅 2026-05-19 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,293 | 🐛 160 | 🌐 Python | 📅 2026-05-21 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [PID-Analyzer](https://github.com/Plasmatree/PID-Analyzer) ⭐ 421 | 🐛 33 | 🌐 Python | 📅 2021-03-04 - Read blackbox and tune PID control variables.
...
* [UAVLogViewer](https://github.com/ardupilot/uavlogviewer) ⭐ 236 | 🐛 138 | 🌐 JavaScript | 📅 2026-05-07 - Web application for Ardupilot logs.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,599 | 🐛 1,032 | 🌐 C++ | 📅 2026-05-22 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,897 | 🐛 443 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,301 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,221 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 746 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 141 | 🐛 12 | 🌐 HTML | 📅 2026-05-08 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,118 | 🐛 3 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,181 | 🐛 725 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,065 | 🐛 47 | 🌐 C++ | 📅 2026-05-19 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,349 | 🐛 574 | 🌐 C++ | 📅 2026-05-22 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 978 | 🐛 0 | 🌐 C | 📅 2026-05-22 - Nano edition, supports also FLARM and more.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 221 | 🐛 39 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [RemoteID Spammer/Spoofer](https://github.com/jjshoots/RemoteIDSpoofer) ⭐ 528 | 🐛 2 | 🌐 C | 📅 2025-09-26 - An ESP8266/NodeMCU Drone RemoteID Spoofer
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 397 | 🐛 19 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 271 | 🐛 5 | 🌐 Python | 📅 2026-05-18 - Webfrontend to map DJI drones using their RemoteID.
...
* [Delta 5 race timer](https://github.com/scottgchin/delta5_race_timer) ⭐ 161 | 🐛 46 | 🌐 JavaScript | 📅 2021-06-08 - Use 5.8GHz video signals to trigger lap counter.
  * [RotorHazard](https://github.com/RotorHazard/RotorHazard) ⭐ 257 | 🐛 66 | 🌐 Python | 📅 2026-05-14 - Sucessor with multinode and central RPI server
