...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 583 | 🐛 23 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,084 | 🐛 34 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 753 | 🐛 98 | 🌐 C | 📅 2026-02-03 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,594 | 🐛 343 | 🌐 C | 📅 2026-02-08 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,706 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,656 | 🐛 67 | 🌐 C | 📅 2026-02-10 - ?.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,167 | 🐛 730 | 🌐 C | 📅 2026-02-10 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,717 | 🐛 55 | 🌐 C | 📅 2026-02-09 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,717 | 🐛 55 | 🌐 C | 📅 2026-02-09 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 514 | 🐛 20 | 🌐 C | 📅 2026-02-10 - Mavlink compatible LRS.
...
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 895 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,238 | 🐛 63 | 🌐 Rust | 📅 2026-01-14 - Use IMU sensor data to smooth HD video recordings.
...
* [AntTracker](https://github.com/zs6buj/AntTracker) ⭐ 186 | 🐛 1 | 🌐 C | 📅 2025-12-04 - Servo based using F1 / ESP8266 / ESP32 controllers, 2019.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,151 | 🐛 139 | 🌐 Python | 📅 2026-02-11 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,321 | 🐛 1,066 | 🌐 C++ | 📅 2026-02-11 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,855 | 🐛 437 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 294 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2026-02-09 - Share Drone shots for disaster response etc.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 1,807 | 🐛 16 | 🌐 C | 📅 2025-06-16 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 17,945 | 🐛 723 | 🌐 C++ | 📅 2025-05-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,891 | 🐛 42 | 🌐 C++ | 📅 2026-02-10 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,204 | 🐛 516 | 🌐 C++ | 📅 2026-02-11 - Multi robot.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 955 | 🐛 0 | 🌐 C | 📅 2026-02-10 - UAV edition, supports also FLARM and more.
...
* [Delta 5 race timer](https://github.com/scottgchin/delta5_race_timer) ⭐ 161 | 🐛 47 | 🌐 JavaScript | 📅 2021-06-08 - Use 5.8GHz video signals to trigger lap counter.
  * [RotorHazard](https://github.com/RotorHazard/RotorHazard) ⭐ 243 | 🐛 63 | 🌐 Python | 📅 2026-02-11 - Sucessor with multinode and central RPI server
