...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,096 | 🐛 35 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 799 | 🐛 106 | 🌐 C | 📅 2026-03-30 - DSHOT, telemetry, 2024
* [BlueJay](https://github.com/mathiasvr/bluejay) ⭐ 550 | 🐛 23 | 🌐 Assembly | 📅 2022-08-31 - BLheli fork, Digital ESC firmware for controlling brushless motors. More features like custom melodies. Since 2020.
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,772 | 🐛 323 | 🌐 C | 📅 2026-03-30 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,718 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,671 | 🐛 72 | 🌐 C | 📅 2026-03-30 - ?.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,222 | 🐛 746 | 🌐 C | 📅 2026-03-30 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,824 | 🐛 56 | 🌐 C | 📅 2026-03-30 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,824 | 🐛 56 | 🌐 C | 📅 2026-03-30 - 2 way link for more complex telemetry downlink.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,328 | 🐛 28 | 🌐 C++ | 📅 2026-03-29 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,411 | 🐛 22 | 🌐 Python | 📅 2026-03-10 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
* [DroneBridge](https://github.com/DroneBridge/DroneBridge) ⭐ 908 | 🐛 17 | 🌐 C | 📅 2022-01-07 - Use 2.4 GHz wifi hardware and RPIs, ESP32 and Android App for bidirectional link, [Comparison](https://dronebridge.gitbook.io/docs/comparison) to the other protocols here.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,358 | 🐛 82 | 🌐 Rust | 📅 2026-03-26 - Use IMU sensor data to smooth HD video recordings.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,216 | 🐛 146 | 🌐 Python | 📅 2026-03-31 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,465 | 🐛 1,039 | 🌐 C++ | 📅 2026-03-30 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 9 | 🌐 JavaScript | 📅 2026-03-31 - Uses GSM and MQTT for extra long range links.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,240 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
* [Faster](https://github.com/mit-acl/faster) ⭐ 1,201 | 🐛 15 | 🌐 C++ | 📅 2025-03-10 - ML let drones learn to avoid obstacles.
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 695 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 138 | 🐛 12 | 🌐 HTML | 📅 2026-03-30 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,019 | 🐛 13 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,973 | 🐛 47 | 🌐 C++ | 📅 2026-03-30 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,272 | 🐛 542 | 🌐 C++ | 📅 2026-03-30 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 965 | 🐛 0 | 🌐 C | 📅 2026-03-30 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 273 | 🐛 45 | 🌐 C | 📅 2026-03-24 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 197 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 364 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
...
* [4AxisFoamCutter](https://github.com/rahulsarchive/4AxisFoamCutter) ⭐ 96 | 🐛 5 | 🌐 nesC | 📅 2021-07-22 - Create aerodynamic wings from foam.
