...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 836 | 🐛 110 | 🌐 C | 📅 2026-04-28 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,912 | 🐛 331 | 🌐 C | 📅 2026-04-30 - Focus on racing and agility for wings and copters.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 491 | 🐛 73 | 🌐 C | 📅 2026-04-30 - Focus on modern algorithms.
...
Radio control transmitters (RC TX, your side) support extension bays with the [JR / JR lite formfactor](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Module_BG_4-in-1.md) ⭐ 1,854 | 🐛 118 | 🌐 C++ | 📅 2025-09-26 and serial interfaces to adapt to different radio protocols. See also Ground station.
Most receivers (RX, drone side) support standard serial protocols like Crossfire (CSRF) to talk with the FC.

* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,259 | 🐛 753 | 🌐 C | 📅 2026-04-30 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,905 | 🐛 51 | 🌐 C | 📅 2026-04-29 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,905 | 🐛 51 | 🌐 C | 📅 2026-04-29 - 2 way link for more complex telemetry downlink.
* [Multi Module](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module) ⭐ 1,854 | 🐛 118 | 🌐 C++ | 📅 2025-09-26 - Supports different protocols like FrSky, FlySky, Walkera, Futaba, ... .
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 554 | 🐛 13 | 🌐 C | 📅 2026-04-29 - Mavlink compatible LRS.
...
* [OpenHD](https://github.com/OpenHD/Open.HD) ⭐ 2,344 | 🐛 26 | 🌐 C++ | 📅 2026-04-30 - Use 2.4 / 5.8 GHz wifi hardware and SBCs on air and groundside to provide a video and telemetry downlink and an optional control uplink. Try to develop a more efficient dedicated hardware board. [Compare different open digital links](https://openhd.gitbook.io/open-hd/general/openhd-vs-alternatives).
...
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,765 | 🐛 556 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,257 | 🐛 152 | 🌐 Python | 📅 2026-04-30 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,553 | 🐛 1,040 | 🌐 C++ | 📅 2026-04-30 - Mavlink, Desktop and mobile.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,280 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 271 | 🐛 25 | 🌐 C++ | 📅 2026-04-28 - Store and archive drone shots and aerial imagery.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,046 | 🐛 3 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,145 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,031 | 🐛 48 | 🌐 C++ | 📅 2026-04-29 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,314 | 🐛 555 | 🌐 C++ | 📅 2026-05-01 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 971 | 🐛 0 | 🌐 C | 📅 2026-04-30 - Nano edition, supports also FLARM and more.
...
* [Drone Remote ID Monitoring System](https://github.com/cyber-defence-campus/RemoteIDReceiver) ⭐ 259 | 🐛 5 | 🌐 Python | 📅 2026-04-13 - Webfrontend to map DJI drones using their RemoteID.
