...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 592 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,095 | 🐛 35 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 798 | 🐛 105 | 🌐 C | 📅 2026-03-22 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,767 | 🐛 318 | 🌐 C | 📅 2026-03-29 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,718 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,670 | 🐛 71 | 🌐 C | 📅 2026-03-27 - ?.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 489 | 🐛 62 | 🌐 C | 📅 2026-03-29 - Focus on modern algorithms.
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,221 | 🐛 743 | 🌐 C | 📅 2026-03-29 - Successor of OpenTX under active development.
...
* [ELRS-Joystick-Control](https://github.com/kaack/elrs-joystick-control) ⭐ 275 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-12 - ELRS Module directly connected to GCS with joysticks.

* [freedomTX](https://github.com/tbs-fpv/freedomtx) ⭐ 68 | 🐛 20 | 🌐 C++ | 📅 2026-03-12 - OpenTX fork, stall since 2020.

* [OpenAVRc](https://github.com/Ingwie/OpenAVRc_Hw) ⭐ 25 | 🐛 0 | 🌐 C | 📅 2026-03-29 - Custom TX based on Arduino Mega2560 boards.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,824 | 🐛 57 | 🌐 C | 📅 2026-03-30 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,824 | 🐛 57 | 🌐 C | 📅 2026-03-30 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 534 | 🐛 16 | 🌐 C | 📅 2026-03-27 - Mavlink compatible LRS.
...
* [EZ Wifibroadcast](https://github.com/rodizio1/EZ-WifiBroadcast) ⭐ 893 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Oldest and first wifi based VTX setup.
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 457 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,355 | 🐛 82 | 🌐 Rust | 📅 2026-03-26 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,706 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 722 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,215 | 🐛 146 | 🌐 Python | 📅 2026-03-26 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 695 | 🐛 12 | 🌐 Lua | 📅 2026-01-23 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,463 | 🐛 1,038 | 🌐 C++ | 📅 2026-03-30 - Mavlink, Desktop and mobile.
...
* [BulletGCSS](https://github.com/danarrib/BulletGCSS) ⭐ 58 | 🐛 9 | 🌐 JavaScript | 📅 2026-03-30 - Uses GSM and MQTT for extra long range links.
...
* [Fast-Planner](https://github.com/HKUST-Aerial-Robotics/Fast-Planner) ⭐ 3,237 | 🐛 84 | 🌐 C++ | 📅 2024-10-24 - Learn drones to avoid obstacles on the course.
...
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 296 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2026-03-24 - Share Drone shots for disaster response etc.
...
* [DroneAid](https://github.com/Call-for-Code/DroneAid) ⭐ 138 | 🐛 11 | 🌐 HTML | 📅 2026-02-14 - ML find persons in disaster response by emergency markers.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,019 | 🐛 16 | 🌐 C | 📅 2026-03-03 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,077 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 1,971 | 🐛 47 | 🌐 C++ | 📅 2026-03-29 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,271 | 🐛 542 | 🌐 C++ | 📅 2026-03-27 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 964 | 🐛 0 | 🌐 C | 📅 2026-03-30 - Nano edition, supports also FLARM and more.
* [Stratux](https://github.com/stratux/stratux) ⭐ 272 | 🐛 45 | 🌐 C | 📅 2026-03-24 - Share position and course via different radio transmitters.
...
* [ArduPilot RemoteID Transmitter](https://github.com/ArduPilot/ArduRemoteID) ⭐ 196 | 🐛 37 | 🌐 C++ | 📅 2025-07-04 - FCC RemoteID with Mavlink and DroneCAN integration.
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 363 | 🐛 17 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
...
* [Robot Vulnerability Database](https://github.com/aliasrobotics/RVD) ⭐ 223 | 🐛 228 | 🌐 Python | 📅 2024-06-24 - CVEs for semi-autonomous machines.
