...
* [TBS Source One](https://github.com/tbs-trappy/source_one) ⭐ 604 | 🐛 24 | 📅 2025-09-17 - Carbon racing frame in 5 revisions, 2021.
...
* [diyBMS v4](https://github.com/stuartpittaway/diyBMSv4) ⭐ 1,107 | 🐛 36 | 🌐 HTML | 📅 2025-07-25 - Battery management PCB and firmware for LiIon packs.
...
* [BLheli\_S](https://github.com/bitdump/BLHeli) ⭐ 2,197 | 🐛 411 | 🌐 Assembly | 📅 2025-08-21 - Popular Firmware for ESCs with fine-grained control.
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 842 | 🐛 111 | 🌐 C | 📅 2026-04-28 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,920 | 🐛 331 | 🌐 C | 📅 2026-05-06 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,722 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,674 | 🐛 72 | 🌐 C | 📅 2026-05-05 - ?.
* [dRehmflight](https://github.com/nickrehm/dRehmFlight) ⭐ 1,386 | 🐛 5 | 🌐 C++ | 📅 2025-01-20 - Dedicated to VTOLs and it's transformation during flight process, Teensy Boards only.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 492 | 🐛 67 | 🌐 C | 📅 2026-05-05 - Focus on modern algorithms.
...
* [The Cube Autopilot](https://github.com/proficnc/The-Cube) ⭐ 156 | 🐛 3 | 🌐 HTML | 📅 2026-04-29 - FC hardware like the Pixhawk 2,
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,264 | 🐛 752 | 🌐 C | 📅 2026-05-06 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,914 | 🐛 54 | 🌐 C | 📅 2026-04-29 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,914 | 🐛 54 | 🌐 C | 📅 2026-04-29 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 557 | 🐛 12 | 🌐 C | 📅 2026-05-05 - Mavlink compatible LRS.
...
* [Wifibroadcast NG](https://github.com/svpcom/wifibroadcast) ⭐ 1,437 | 🐛 22 | 🌐 Python | 📅 2026-04-30 - Use 2.4 / 5.8 GHz wifi hardware and RPIs to provide a video and telemetry downlink.
...
* [OpenVTx](https://github.com/OpenVTx/OpenVTx) ⭐ 471 | 🐛 19 | 🌐 C | 📅 2024-04-04 - Free firmware for open hardware anlog VTX.
* [wtfos](https://github.com/fpv-wtf/wtfos) ⭐ 318 | 🐛 37 | 🌐 Shell | 📅 2025-04-13 - Rooting and mod DJI FPV sender and receiver.
* [hx-esp32-cam-fpv](https://github.com/RomanLut/hx-esp32-cam-fpv) ⭐ 191 | 🐛 9 | 🌐 C++ | 📅 2026-04-30- Cheap ESPcam boards transimitting MJPEG frames.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,459 | 🐛 82 | 🌐 Rust | 📅 2026-05-05 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,776 | 🐛 558 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
* [STORM32BGC](https://github.com/olliw42/storm32bgc) ⭐ 733 | 🐛 4 | 🌐 C++ | 📅 2025-11-30 - Firmware and brushless gimbal controller.
...
* [FENIX-rx5808-pro-diversity](https://github.com/JyeSmith/FENIX-rx5808-pro-diversity) ⭐ 106 | 🐛 5 | 🌐 C++ | 📅 2021-03-06 - Open Hardware 5,8GHz analog module with diversity for googles.
  * [rx5808 pro divesity](https://github.com/sheaivey/rx5808-pro-diversity) ⭐ 725 | 🐛 42 | 🌐 C++ | 📅 2024-02-21
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,261 | 🐛 155 | 🌐 Python | 📅 2026-05-05 - Modern extensible protocol from hobbiests ... commercial UAV.
* [betaflight-tx-lua-scripts](https://github.com/betaflight/betaflight-tx-lua-scripts) ⭐ 707 | 🐛 9 | 🌐 Lua | 📅 2026-04-16 - Script to show telemetry and control e.g. CAM, VTX settings.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,564 | 🐛 1,037 | 🌐 C++ | 📅 2026-05-05 - Mavlink, Desktop and mobile.
...
* [DroneKit](https://github.com/dronekit/dronekit-python) ⭐ 1,887 | 🐛 443 | 🌐 Python | 📅 2024-05-30 - Multi platform integration ecosystem including Mavlink radio link.
...
* [Anti-UAV](https://github.com/ZhaoJ9014/Anti-UAV) ⭐ 732 | 🐛 30 | 🌐 Python | 📅 2025-05-07 - ML detect quadcopters within IR / RGB videos
* [OpenAerialMap](https://github.com/hotosm/OpenAerialMap/) ⭐ 294 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2026-05-04 - Share Drone shots for disaster response etc.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 272 | 🐛 26 | 🌐 C++ | 📅 2026-05-05 - Store and archive drone shots and aerial imagery.
* [Fire Detection UAV](https://github.com/AlirezaShamsoshoara/Fire-Detection-UAV-Aerial-Image-Classification-Segmentation-UnmannedAerialVehicle) ⭐ 248 | 🐛 8 | 🌐 Python | 📅 2021-05-06 - ML learn drones to spot fire.
...
* [ESP-Drone](https://github.com/Circuit-Digest/ESP-Drone) ⭐ 2,053 | 🐛 3 | 🌐 C | 📅 2026-03-30 - ESP32 and PCB only based quadcopter without FPV but custom wifi on brushed
...
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,039 | 🐛 48 | 🌐 C++ | 📅 2026-05-05 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,319 | 🐛 559 | 🌐 C++ | 📅 2026-05-06 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 973 | 🐛 0 | 🌐 C | 📅 2026-05-06 - Nano edition, supports also FLARM and more.
...
* [Drone-ID Receiver for DJI OcuSync 2.0](https://github.com/RUB-SysSec/DroneSecurity) ⭐ 1,244 | 🐛 22 | 🌐 Python | 📅 2023-03-10 - Decoding DJI radio transmissions including DroneID and pilot location with SDR in python
...
* [RFUAV](https://github.com/kitoweeknd/RFUAV) ⭐ 389 | 🐛 19 | 🌐 Python | 📅 2025-12-09 - Radio based drone detection and signal fingerprinting.
