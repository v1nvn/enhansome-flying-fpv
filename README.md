...
* [AM32-MultiRotor-ESC-FW](https://github.com/am32-firmware/AM32) ⭐ 825 | 🐛 107 | 🌐 C | 📅 2026-04-17 - DSHOT, telemetry, 2024
...
* [betaflight](https://github.com/betaflight/betaflight) ⭐ 10,881 | 🐛 324 | 🌐 C | 📅 2026-04-22 - Focus on racing and agility for wings and copters.
* [CleanFlight](https://github.com/cleanflight/cleanflight) ⭐ 2,721 | 🐛 1 | 🌐 C | 📅 2023-10-20 - Legacy fork of baseflight , stall.
* [Paparazzi UAV](https://github.com/paparazzi/paparazzi) ⭐ 1,672 | 🐛 69 | 🌐 C | 📅 2026-04-22 - ?.
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 491 | 🐛 68 | 🌐 C | 📅 2026-04-22 - Focus on modern algorithms.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 417 | 🐛 4 | 🌐 C | 📅 2026-03-15 - For Arduino based target boards, different sensors supported, 2024
...
* [EdgeTX](https://github.com/EdgeTX/edgetx) ⭐ 2,247 | 🐛 757 | 🌐 C | 📅 2026-04-23 - Successor of OpenTX under active development.
...
* [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) ⭐ 4,883 | 🐛 48 | 🌐 C | 📅 2026-04-23 - ELRS for long range or better latency. support. flashing some existing hardware, but also provide commercial modules for 868/915 MHz or 2.4 / 5.8 GHz.
  * [ELRS Airport Firmware](https://github.com/ExpressLRS/ExpressLRS/pull/1904) ⭐ 4,883 | 🐛 48 | 🌐 C | 📅 2026-04-23 - 2 way link for more complex telemetry downlink.
...
* [mLRS](https://github.com/olliw42/mLRS) ⭐ 548 | 🐛 11 | 🌐 C | 📅 2026-04-23 - Mavlink compatible LRS.
...
* [Gyroflow](https://github.com/gyroflow/gyroflow) ⭐ 8,424 | 🐛 75 | 🌐 Rust | 📅 2026-04-22 - Use IMU sensor data to smooth HD video recordings.
* [opentrack](https://github.com/opentrack/opentrack) ⭐ 4,753 | 🐛 555 | 🌐 C++ | 📅 2026-03-25 - Use integrated trackers of FPV googles or VR headsets as input.
...
* [MAVlink](https://github.com/mavlink/mavlink) ⭐ 2,246 | 🐛 148 | 🌐 Python | 📅 2026-04-22 - Modern extensible protocol from hobbiests ... commercial UAV.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,526 | 🐛 1,053 | 🌐 C++ | 📅 2026-04-23 - Mavlink, Desktop and mobile.
...
* [Fire Detection UAV](https://github.com/AlirezaShamsoshoara/Fire-Detection-UAV-Aerial-Image-Classification-Segmentation-UnmannedAerialVehicle) ⭐ 248 | 🐛 7 | 🌐 Python | 📅 2021-05-06 - ML learn drones to spot fire.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,118 | 🐛 724 | 🌐 C++ | 📅 2026-03-15 - By Microsoft for algorithm testing.
* [JSBsim](https://github.com/JSBSim-Team/jsbsim) ⭐ 2,014 | 🐛 50 | 🌐 C++ | 📅 2026-04-22 - With bindings to Python, Matlab.
* [GAZEBOsim](https://github.com/gazebosim/gz-sim) ⭐ 1,297 | 🐛 551 | 🌐 C++ | 📅 2026-04-23 - Multi robot.
...
* [SoftRF](origin/hhttps:/github.com/lyusupov/SoftRF/wiki/Nano-Edition) ⭐ 971 | 🐛 0 | 🌐 C | 📅 2026-04-22 - Nano edition, supports also FLARM and more.
